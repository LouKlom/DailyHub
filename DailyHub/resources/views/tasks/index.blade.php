                    ...
                    <tr class="hover:bg-gray-50/70 transition">
                        ...
                        <td class="p-4 text-right">
                            <div class="inline-flex gap-1.5">
                                <button title="Voir" class="p-2 bg-slate-100 text-slate-600 rounded-lg hover:bg-slate-200 transition text-xs font-medium">
                                    See More
                                </button>
                                <button title="Modifier" class="p-2 bg-indigo-50 text-indigo-600 rounded-lg hover:bg-indigo-100 transition text-xs font-medium">
                                    Edit
                                </button>
                                <button title="Supprimer" class="p-2 bg-rose-50 text-rose-600 rounded-lg hover:bg-rose-100 transition text-xs font-medium">
                                    Finish
                                </button>
                            </div>
                        </td>
